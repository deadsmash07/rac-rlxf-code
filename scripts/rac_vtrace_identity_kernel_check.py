...
Authoring metadata
------------------
- Author: iter+N+RLxF-resume-26 SCRIPT-author (Opus 4.7 1M-context, MAX 4D)
- Iteration: iter+N+RLxF-resume-26
...
<1e-5. The threshold for PASS is <1e-5 per the iter+N+RLxF-resume-26 spec.
